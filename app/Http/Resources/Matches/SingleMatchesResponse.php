...
class SingleMatchesResponse extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
         return [
             ...
             "winner" => $this->when(!is_null($this->winner),optional($this->winner)->shortenName),
             "winner_set_one"=> optional($this->winnerSetOne)->shortenName,
             "set_one"=> $this->set_one,
             "winner_set_two"=> optional($this->winnerSetTwo)->shortenName,
